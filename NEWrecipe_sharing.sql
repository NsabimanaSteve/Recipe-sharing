...
-- Create the 'users' table (remove the duplicate CREATE statement)
CREATE TABLE `users` (
...
-- Insert a user (remove the duplicate entry or change username)
INSERT INTO users (`user_name`, `email`, `password`)VALUES
('Eugene Daniels', 'superadmin@gmail.com', '$2y$10$7WmxtQVB6.CiA7nkwfc4ROGKmSboAjpGfV0CnObeFivXZ8jfW/9De');
